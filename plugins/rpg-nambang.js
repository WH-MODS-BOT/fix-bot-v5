...
setTimeout(() => {
		...
		['Inventory', '/inv']
                     ...
                     setTimeout(() => {
                     conn.sendButton(m.chat, jln4, botdate, null, [
		['Tunggu...', 'ok']
	], m)
                      }, 25000)
                
                     setTimeout(() => {
                     conn.sendButton(m.chat, jln3, botdate, null, [
		['Tunggu...', 'ok']
	], m)
                     }, 23000) 
                        
                     setTimeout(() => {
                     conn.sendButton(m.chat, jln2, botdate, null, [
		['Tunggu...', 'ok']
	], m)
                     }, 21000) 
                    
                     setTimeout(() => {
                     conn.sendButton(m.chat, jln, botdate, null, [
		['Tunggu...', 'ok']
	], m)
                     }, 19000) 
                     
                     setTimeout(() => {
                     conn.sendButton(m.chat, `🔍 ${penambang} Mencari Area Nambang.....`, botdate, null, [
		['Tunggu...', 'ok']
	], m)
                     }, 0) 
