...
${ usedPrefix }cook`    
        setTimeout(() => {
        conn.sendButton(m.chat, mcng, botdate, null, [
		['Inventory', '/inv']
	], m)
         if (psepick > 0 ) {
        ...
        setTimeout(() => {
                     conn.sendButton(m.chat, `${pemancing} Sepertinya dapat sesuatu..`, botdate, null, [
		['Tunggu...', 'ok']
	], m)
                      }, 28000)
       setTimeout(() => {
                     conn.sendButton(m.chat, `${pemancing} Menunggu`, botdate, null, [
		['Tunggu...', 'ok']
	], m)
                      }, 8000)
       setTimeout(() => {
                     conn.sendButton(m.chat, `${pemancing} Sedang Memancing...`, botdate, null, [
		['Tunggu...', 'ok']
	], m)
                      }, 0)
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendButton(m.chat, `${pemancing} Yuk mancing mania level easy lagi`, botdate, null, [
		[null, null]
	], m)
                                }, 28800000) 
                                setTimeout(() => {
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendButton(m.chat, `${pemancing} Yuk mancing mania level normal lagi`, botdate, null, [
		[null, null]
	], m)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendButton(m.chat, hsls, botdate, null, [
		['Inventory', '/inv']
	], m)
                                }, 12000) 
                                setTimeout(() => {
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendButton(m.chat, `${pemancing} Yuk mancing mania level hard lagi`, botdate, null, [
		[null, null]
	], m)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendButton(m.chat, hslsh, botdate, null, [
		['Inventory', '/inv']
	], m)
                                }, 12000) 
                                setTimeout(() => {
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendButton(m.chat, `${pemancing} Yuk mancing mania level extreme lagi`, botdate, null, [
		[null, null]
	], m)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendButton(m.chat, hslse, botdate, null, [
    ['Inventory', '/inv']
	], m)
                                }, 12000) 
                                setTimeout(() => {
