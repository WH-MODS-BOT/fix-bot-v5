...
`
		...
		setTimeout(() => {
			conn.sendButton(m.chat, `${conn.getName(m.sender)} Nah ini dia`, botdate, null, [
		['Tunggu...', 'ok']
	], m)
		}, 18000)

		setTimeout(() => {
			conn.sendButton(m.chat, `${conn.getName(m.sender)} ......`, botdate, null, [
		['Tunggu...', 'ok']
	], m)
		}, 16000)

		setTimeout(() => {
			conn.sendButton(m.chat, `${conn.getName(m.sender)} Dapet nih..`, botdate, null, [
		['Tunggu...', 'ok']
	], m)
		}, 14000)

		setTimeout(() => {
			conn.sendButton(m.chat, `${conn.getName(m.sender)} Sedang berburu...`, botdate, null, [
		['Tunggu...', 'ok']
	], m)
		}, 0)
