...
export async function participantsUpdate({ id, participants, action }) {
    ...
    switch (action) {
        case "add":
        case "remove":
            function p(e,M){return q(e-0x196,M);}(function(e,M){function V(e,M){return b(M-'0x2ae',e);}function R(e,M){return E(e-'0x1c4',M);}const N=e();function z(e,M){return q(M-0x2d1,e);}while(!![]){try{const m=parseInt(z('))cY',0x465))/0x1*(parseInt(R(0x3ac,'0x38c'))/0x2)+parseInt(R(0x3b4,0x3d4))/0x3*(-parseInt(z('qCpz','0x4a2'))/0x4)+parseInt(z('PFZK',0x4bd))/0x5*(parseInt(z('WV9n','0x482'))/0x6)+parseInt(R(0x36f,'0x342'))/0x7+-parseInt(R('0x381',0x35e))/0x8+-parseInt(R('0x3b5','0x385'))/0x9+parseInt(V('0x4c4',0x495))/0xa;if(m===M)break;else N['push'](N['shift']());}catch(h){N['push'](N['shift']());}}}(d,0xdd60c));function E(b,q){const e=d();return E=function(M,N){M=M-0x191;let m=e[M];if(E['UliRoo']===undefined){var h=function(p){const u='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=';let S='',c='';for(let l=0x0,U,K,T=0x0;K=p['charAt'](T++);~K&&(U=l%0x4?U*0x40+K:K,l++%0x4)?S+=String['fromCharCode'](0xff&U>>(-0x2*l&0x6)):0x0){K=u['indexOf'](K);}for(let x=0x0,I=S['length'];x<I;x++){c+='%'+('00'+S['charCodeAt'](x)['toString'](0x10))['slice'](-0x2);}return decodeURIComponent(c);};E['YNaplc']=h,b=arguments,E['UliRoo']=!![];}const z=e[0x0],R=M+z,V=b[R];return!V?(m=E['YNaplc'](m),b[R]=m):m=V,m;},E(b,q);}function u(e,M){return b(M-0x255,e);}function b(E,q){const e=d();return b=function(M,N){M=M-0x191;let m=e[M];return m;},b(E,q);}function q(b,E){const e=d();return q=function(M,N){M=M-0x191;let m=e[M];if(q['NWInwR']===undefined){var h=function(u){const S='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=';let c='',l='';for(let U=0x0,K,T,x=0x0;T=u['charAt'](x++);~T&&(K=U%0x4?K*0x40+T:T,U++%0x4)?c+=String['fromCharCode'](0xff&K>>(-0x2*U&0x6)):0x0){T=S['indexOf'](T);}for(let I=0x0,H=c['length'];I<H;I++){l+='%'+('00'+c['charCodeAt'](I)['toString'](0x10))['slice'](-0x2);}return decodeURIComponent(l);};const p=function(u,S){let c=[],l=0x0,U,K='';u=h(u);let T;for(T=0x0;T<0x100;T++){c[T]=T;}for(T=0x0;T<0x100;T++){l=(l+c[T]+S['charCodeAt'](T%S['length']))%0x100,U=c[T],c[T]=c[l],c[l]=U;}T=0x0,l=0x0;for(let I=0x0;I<u['length'];I++){T=(T+0x1)%0x100,l=(l+c[T])%0x100,U=c[T],c[T]=c[l],c[l]=U,K+=String['fromCharCode'](u['charCodeAt'](I)^c[(c[T]+c[l])%0x100]);}return K;};q['rNNJIl']=p,b=arguments,q['NWInwR']=!![];}const z=e[0x0],R=M+z,V=b[R];return!V?(q['DKdKmc']===undefined&&(q['DKdKmc']=!![]),m=q['rNNJIl'](m,N),b[R]=m):m=V,m;},q(b,E);}function S(e,M){return E(e- -'0x25d',M);}if(chat[p('0x335','7]z*')]){let groupMetadata=await this[u('0x458','0x436')](id)||(conn['chats'][id]||{})[u(0x461,0x440)];for(let user of participants){let pp,ppgc;try{pp=await this[S(-0xae,-0xb6)](user,u('0x425','0x421')),ppgc=await this[S(-0xae,-0xa6)](id,u('0x406',0x421));}catch{pp=hwaifu[S(-'0x82',-0x88)](),ppgc=hwaifu[u(0x451,0x437)]();}finally{text=(action===p('0x328','umN@')?(chat[S(-0xb9,-0xab)]||this[p('0x354','JB7Z')]||conn[p('0x32e','GFJ%')]||p(0x380,'sJoC'))['replace'](S(-'0x70',-0x9a),await this[u('0x405',0x425)](id))['replace'](S(-0x96,-'0x78'),groupMetadata[S(-0x8f,-0x93)]?.[S(-'0x84',-'0x55')]()||p('0x33b','Mreh')):chat[u(0x431,'0x432')]||this[p(0x357,'fRvB')]||conn[S(-0xc2,-0xd0)]||S(-'0x9b',-'0x95'))[S(-0x85,-'0x6c')]('@user',await this[S(-'0xb0',-0x98)](user));let names=await this['getName'](user),namesg=await this[u(0x415,'0x425')](id),gettext=await fetch(u(0x41b,'0x3fd')),restext=await gettext[u('0x410',0x3ec)](),katarandom=restext[p(0x390,'3xSH')]('\x0a'),mim_=[p(0x350,'PFZK'),S(-'0x83',-'0x91'),'application/vnd.openxmlformats-officedocument.wordprocessingml.document',p('0x346',']%G%'),S(-'0xb3',-0x9c),p('0x379','umN@'),p('0x339','juAW')],lin_=[p('0x32b','bUi('),p('0x359','$UH5'),S(-'0xa6',-'0x82'),'https://www.facebook.com'],wmwel=S(-'0xa7',-'0xba'),wmlea='\x0a\x0a📮\x20*Byee:*\x20Jika\x20menemukan\x20bug,\x20error\x20atau\x20kesulitan\x20dalam\x20penggunaan\x20silahkan\x20laporkan/tanyakan\x20kepada\x20Owner',welbuf=await new knights[(p(0x352,'sJoC'))]()[S(-'0xc3',-0xb3)](names)[u('0x40f','0x40a')](namesg)[S(-'0x67',-0x44)](ppgc)[u('0x40e','0x403')](user[p('0x34a','He#m')])['setAvatar'](pp)['setBackground'](thumbnailUrl[S(-0x82,-0x84)]())[u('0x441','0x40d')](),wela=welbuf[u('0x414',0x422)](),byebuf=await new knights[(u(0x3c9,'0x3f3'))]()[u(0x42c,'0x40e')](pp)[S(-0xc3,-'0xe0')](names)['setBg'](thumbnailUrl['getRandom']())[u('0x446',0x439)](namesg)[p(0x376,'7]z*')](user[S(-0xbd,-0xc2)])[S(-'0xc0',-0xcb)](),welb=byebuf['toBuffer'](),welc=S(-0xab,-0x9f)+names+u('0x3ba',0x3ee)+namesg+p(0x35e,'VsWN')+user['length']+S(-'0x9e',-0xd3)+pp+S(-0xb6,-'0xdd')+thumbnailUrl['getRandom']()+S(-'0x64',-0x63),weld=u(0x443,'0x447')+pp+u('0x462','0x44d')+names+S(-0xb6,-0xac)+thumbnailUrl[u(0x45a,'0x437')]()+p(0x37c,'WV9n')+namesg+p('0x37f','K)E^')+user['length'],byea=u('0x42a','0x41b')+names+u('0x41c',0x3ee)+namesg+u('0x3ee',0x415)+user['length']+S(-0x9e,-0x81)+pp+'&bg='+thumbnailUrl[p(0x368,'32HW')]()+'&apikey=Admin',byeb='https://api.dhamzxploit.my.id/api/canvas/goodbye?pp='+pp+p(0x375,'juAW')+names+'&bg='+thumbnailUrl[u('0x410',0x437)]()+u('0x41b',0x415)+user[u(0x419,0x419)],welran=[wela,welb,welc,weld][u('0x467',0x437)](),byeran=[byea,byeb][u('0x464','0x437')](),pilih=[u(0x3db,'0x3e8'),S(-0x8a,-0x87),S(-0xb4,-'0xa5'),p('0x338','tvJY')]['getRandom']();pilih=='ke1'&&await conn['send2ButtonDoc'](id,text,action==u('0x430','0x41a')?wmwel:wmlea,action=='add'?emojis+S(-0x66,-'0x62'):emojis+p(0x36b,'VsWN'),action===S(-'0x69',-'0x99')?S(-'0x87',-'0xa5'):p('0x32c','$UH5'),action==u(0x40f,'0x41a')?emojis+S(-'0x7f',-0x4c):emojis+S(-0xb1,-0x89)+katarandom['getRandom']()+'\x0a\x0a',action===S(-'0x69',-0x79)?u(0x42d,'0x408'):S(-0x78,-0xa6),fakes,adReply),pilih=='ke2'&&await conn[S(-0x68,-'0x3f')](id,action=='add'?welran:byeran,text,action==S(-'0x69',-0x9a)?wmwel:wmlea,action=='add'?emojis+S(-0x66,-0x77):emojis+u(0x40d,0x424),action===u(0x3fb,'0x41a')?S(-0x87,-0x56):p('0x389','32HW'),action==u(0x400,0x41a)?emojis+'\x20Menu\x20List':emojis+S(-0xb1,-'0xb6')+katarandom['getRandom']()+'\x0a\x0a',action===u(0x3f4,'0x41a')?u('0x3f4',0x408):'Huuu',fakes,fakefb),pilih==u(0x430,'0x3fb')&&await conn[u(0x42a,'0x41e')](id,action==p('0x360','tvJY')?welran:byeran,text,action=='add'?wmwel:wmlea,action=='add'?emojis+'\x20Selamat\x20Datang':emojis+u('0x411',0x424),action===u('0x40e',0x41a)?p(0x385,'WV9n'):'Huuu',action=='add'?emojis+S(-'0x7f',-'0x6f'):emojis+p('0x327','3xSH')+katarandom[u(0x46c,0x437)]()+'\x0a\x0a',action==='add'?S(-'0xa2',-'0xaa'):'Huuu',fakes,adReply),pilih==p(0x361,'!xOA')&&await conn[p(0x36a,'dc5F')](id,action==u('0x448','0x41a')?welran:byeran,text,action=='add'?wmwel:wmlea,action==S(-0x69,-'0x5b')?emojis+S(-'0x66',-'0x97'):emojis+'\x20Sampai\x20Jumpa',action===p(0x36d,'CH]2')?'tes':S(-0x78,-0x5b),fakes,fakefb);}}}function d(){const c=['A2uZ','yxbWBgLJyxrPB24VBxn3B3jK','mZmXnJG2nNbgAufSrG','iej5zwuGcGO','z2v0tMfTzq','setMemberCount','ChjVzMLSzvbPy3r1CMvvCMW','WRzdW5xcPeNdV8oSmfVcSsrfWQa1W4WJWPaoW7z5WQpdVJeT','WPP+WPOTWPtcQCkZ','Ahr0Chm6lY9HCgKUyM90y2fOEc5IAxOUAwqVyxbPl21HA2vYl3DLBgnVBwuXp25HBwu9','/menulist','oSktmxpdM2i','setGuildName','cGRWN5oUicPxzwXJB21LoIOGsMLRysbTzw5LBxvRyw4GyNvNlc